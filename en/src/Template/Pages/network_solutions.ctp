...
<div class="page-intro2">
    <div class="container">
        ...
        <p class="font18" style="color:#bf1718">Nhiều giải pháp cho nhu cầu lựa chọn Hosting</p>
    </div>
</div><!--/.page-intro-->
...
<div class="lp-row-gray t_center">
    <div class="container">
        <h2 class="mb30">Tại sao có nhiều loại Hosting</h2>
        <p class="font16">Việc lựa chọn nhà cung cấp tin cậy để quản lý dịch vụ của bạn là điều may mắn với chúng tôi. Do đó chúng tôi sẽ không để bạn 
            mất niềm tin một lần nữa, Dịch vụ Hosting của bạn sẽ được đội ngũ kỹ thuật của chúng tôi thay bạn chuyển dữ liệu một cách an 
            toàn nhất và không bị giám đoạn 1s nào?</p>
    </div>
</div>
