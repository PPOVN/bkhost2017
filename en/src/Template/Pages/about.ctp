        ...
        <div class="content-wrap">
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <h1 style="text-transform:none">CHÚNG TÔI HỖ TRỢ 24/24</h1>
                        <h3>Nhà cung cấp thuộc TOP dịch vụ trên Internet</h3>
                        <p class="font15">Các nhà lãnh đạo BKHOST chúng tôi là những chuyên gia về CNTT. Chúng luôn tạo nên tảng tốt nhất để thay đổi các doanh nghiệp tiếp 
tận đến CNTT một cách hiệu quả. Bằng cách sử dụng những sản phẩm tốt nhất của chúng tôi. Chúng tôi tin tưởng sẽ đem đến các giải 
pháp CNTT mới nhất, tối ưu nhất, hiêu quả nhất và chi phí hợp lý nhất cho tất cả các doanh nghiệp với mọi quy mô.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb30">
                <div class="about-vision">
                    ...
                    <div class="pull-left right">
                        Chúng tôi luôn tự hào khi góp phần thành công  đến  doanh  nghiệp  của  bạn  khi  sử 
dụng  dịch  vụ  của  chúng  tôi.  Chúng  tôi luôn cam kết đem đến sản phẩm tốt nhất, 
giá phải chăng nhất và hỗ trợ tốt nhất bởi đội ngũ chuyên giá của chúng tôi.
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-6">
                <div class="row item">
                    ...
                    <div class="col-xs-9">
                        ...
                        <p>Hệ tầng đạt chuẩn Quốc tế với tốc độ băng thông cực cao sẽ đem đến tốc độ truy suất không giới hạn.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                <div class="row item">
                    ...
                    <div class="col-xs-9">
                        ...
                        <p>Chúng tôi liên tục đầu tư vào các phần cứng mới nhất và cơ sở hạ tầng, đảm bảo rằng bạn sẽ có được hiệu suất tốt nhất và ổn định cao.</p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
...
<div class="lp-row-white">
    <div class="container">
        ...
        <p class="mb50 font16 t_center">Để phục vụ cho công việc hỗ trợ khách hàng của chúng tôi, BKHOST đã có nhiều chương trình đào tạo 
            nâng cao năng lực chuyên môn kỹ thuật cho đội ngũ nhân viên phải trải qua. Tính đến tháng 9 năm 2017, BKHOST có hơn 20 kỹ sư 
            ...
            <div class="col-sm-6 mb30">
                <div class="row">
                    ...
                    <div class="col-xs-9 pdl0">
                        ...
                        <p style="text-align: justify">Mr Thanh là người sáng lập kiêm CEO của BKHOST Việt Nam, ông chịu trách 
...
<div class="lp-row-gray partner-technical">
    <div class="container">
        ...
        <p class="t_center font15 mb50">Để phục vụ cho công việc hỗ trợ khách hàng của chúng tôi, BKHOST đã có nhiều chương trình đào tạo nâng cao năng lực chuyên môn kỹ thuật cho đội ngũ nhân viên 
phải trải qua. Tính đến tháng 9 năm 2017, BKHOST có hơn 20 kỹ sư hệ thống, chăm sóc khách hàng và đội ngũ cộng tác viên chuyên nghiệp hỗ trợ cho bạn.</p>
        <div class="row">
            <div class="col-sm-6">
                <div class="item">
                    <div class="col-xs-3">
