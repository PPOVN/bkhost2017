    ...
    <div class="form-wrap">
        <form action="<?= $this->Url->build(['controller' => 'Domain', 'action' => 'search']) ?>" method="post">
            <div style="overflow: hidden">
                <input type="text" name="domain" value="<?php echo (isset($_POST['domain']))?$_POST['domain']:"" ?>" placeholder="Start your domain search ..." />
                <button class="btn btn-submit"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> SEARCH</button>
