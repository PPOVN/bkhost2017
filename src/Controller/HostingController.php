...
class HostingController extends AppController {
    ...
    public function personal() {
        $meta_description = __('Dịch vụ mua hosting giá rẻ với công nghệ SSD, Website bạn sẽ load web trong 1s, Chúng tôi cam kết chất lượng tốt nhất, hỗ trợ tốt nhất 24/7. Đăng ký ngay!');
        $og_type = "article";
