    ...
    <div class="container">
        ...
        <div class="content-wrap">
            <div class="content" style="padding-left: 240px">
                <h2>Hosting cá nhân</h2>
                <h3>Giá cả phải chăng, Setup website nhanh chóng</h3>
                <p>Với mức chi phí vừa phải và hợp lý luôn thích hợp cho các Website cá nhân để mua hosting giá rẻ của chúng tôi trong giai đoạn đầu phát triển, tuy nhiên
                    dịch vụ luôn đem lại hiệu xuất cao nhất và chúng tôi đảm bảo hoàn lại tiền 30 ngày nếu bạn không hài lòng với dịch vụ. Quý khách thường hỏi thuê hosting ở đâu tốt nhất thì chúng tôi tin tưởng rằng BKHOST là lựa chọn cho bạn. </p>
            </div>
        </div>
    </div>
    <div class="container">
        <h2 class="t_center mt30 mb30">Những yếu tố nổi trội Hosting cá nhân</h2>
        <div class="row">
            ...
            <div class="col-sm-4 col-xs-6">
                <div class="item-wrap">
                    <div class="item">
                        ...
                        <div class="pull-right">Nhiều lựa chọn phiên bản PHP cho Website Php 5.2 đến 7.0 và Miễn phí SSL với Let's Encrypt</div>
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="hosting-column">
            ...
            <div class="column-body">
                <ul>
					<li><strong><font color="red">Dung Lượng SSD: 700 MB</font></strong></li>
            ...
            <div class="column-footer">
                <div class="price"><span>23,5K</span>1 Tháng</div>
                <div class="promo-code">Nhập mã khuyến mãi (-50%) ÁP DỤNG 05/12 - 30/12/2017<strong>KMHT850</strong></div>
                <a href="https://manage.bkhost.vn/cart.php?a=add&pid=10" class="btn btn-warning">Đăng ký</a>
            </div>
        </div><!--/.hosting-column-->
        <div class="hosting-column">
            <div class="column-header">
            ...
            <div class="column-body">
                <ul>
                    <li><strong><font color="red">Dung lượng SSD: 1 GB</font></strong></li>
            ...
            <div class="column-footer">
                <div class="price"><span>40K</span>1 Tháng</div>
                <div class="promo-code">Nhập mã khuyến mãi (-50%) ÁP DỤNG 05/12 - 30/12/2017<strong>KMHT850</strong></div>
                <a href="https://manage.bkhost.vn/cart.php?a=add&pid=11" class="btn btn-warning">Đăng ký</a>
            </div>
        </div><!--/.hosting-column-->
        <div class="hosting-column hosting-column-highlight">
            ...
            <div class="column-body">
                <ul>
                    <li><strong><font color="red">Dung lượng SSD: 2 GB</font></strong></li>
            ...
            <div class="column-footer">
                <div class="price"><span>80,5K</span>1 Tháng</div>
                <div class="promo-code">Nhập mã khuyến mãi (-50%) ÁP DỤNG 05/12 - 30/12/2017<strong>KMHT850</strong></div>
                <a href="https://manage.bkhost.vn/cart.php?a=add&pid=12" class="btn btn-warning">Đăng ký</a>
            </div>
        </div><!--/.hosting-column-->
        <div class="hosting-column">
            <div class="column-header">
            ...
            <div class="column-body">
                <ul>		
                    <li><strong><font color="red">Dung lượng SSD: 3 GB</font></strong></li>
					<li><strong><font color="red">Băng thông: Unlimited</font></strong></li>
            ...
            <div class="column-footer">
               <div class="price"><span>125K</span>1 Tháng</div>
                <div class="promo-code">Nhập mã khuyến mãi (-50%) ÁP DỤNG 05/12 - 30/12/2017<strong>KMHT850</strong></div>
                <a href="https://manage.bkhost.vn/cart.php?a=add&pid=13" class="btn btn-warning">Đăng ký</a>
            </div>
        </div><!--/.hosting-column-->
        <div class="hosting-column last">
            ...
            <div class="column-body">
                <ul>
                    <li><strong><font color="red">Dung lượng SSD: 10 GB</font></strong></li>
					<li><strong><font color="red">Băng thông: Unlimited</font></strong></li>
            ...
            <div class="column-footer">
                <div class="price"><span>165K</span>1 Tháng</div>
                <div class="promo-code">Nhập mã khuyến mãi (-50%) ÁP DỤNG 05/12 - 30/12/2017<strong>KMHT850</strong></div>
                <a href="https://manage.bkhost.vn/cart.php?a=add&pid=14" class="btn btn-warning">Đăng ký</a>
            </div>
        </div><!--/.hosting-column-->
        <div class="clearfix"></div>
