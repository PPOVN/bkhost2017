...
<div class="customer-list">
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <div class="item">
                    <a href="https://bkhost.vn/" title="BKHOST Việt Nam" target="_blank"><?= $this->Html->image('customers/1.png1', ['alt' => 'BKHOST Việt Nam']) ?></a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="item">
                    <a href="https://bkhost.vn/" title="BKHOST Việt Nam" target="_blank"><?= $this->Html->image('customers/2.png1', ['alt' => 'BKHOST Việt Nam']) ?></a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="item">
                    <a href="https://bkhost.vn/" title="BKHOST Việt Nam" target="_blank"><?= $this->Html->image('customers/ppo-viet-nam.jpg1', ['alt' => 'BKHOST Việt Nam']) ?></a>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="item">
