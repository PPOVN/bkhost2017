...
<div class="page-intro2">
    <div class="container">
        ...
        <p>Nếu bạn đang sử dụng dịch vụ bên nhà cung cấp khác và muốn chuyển về BKHOST chúng tôi, Đội ngũ kỹ thuật của chúng tôi sẽ giúp bạn 
            thực hiện việc chuyển dữ liệu. Bạn đừng lo lắng vì chúng tôi cam kết chuyển đổi liền mạch với dịch vụ của bạn mà không bị giám đoạn 
            trong 1s nào. Hãy để cho chúng tôi thực hiện thay bạn.</p>
    </div>
</div><!--/.page-intro2-->
...
<div class="lp-row-white">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="title-red mb30">Chuyển dữ liệu về BKHOST</h3>
                <p>Việc lựa chọn nhà cung cấp tin cậy để quản lý dịch vụ của bạn là điều may mắn với chúng tôi. 
                    Do đó chúng tôi sẽ không để bạn mất niềm tin một lần nữa, Dịch vụ của bạn sẽ được đội ngũ kỹ thuật cao
                    của chúng tôi thay bạn chuyển dữ liệu một cách an toàn nhất và không bị giám đoạn.</p>
            </div>
            <div class="col-sm-6">
...
<div class="lp-row-gray t_center">
    <div class="container">
        ...
        <p class="font20">Chuyển dữ liệu cho bạn là điều đơn giản với chúng tôi, hãy để kỹ thuật chúng tôi hỗ trợ bạn làm điều này. Gọi cho chúng tôi tại 
            <a href="tel:02462591442">024 6259 1442</a> - <a href="tel:0866870620">08 6687 0620 hoặc gửi email <a href="mailto:info@Bkhost.vn">info@Bkhost.vn</a></p>
    </div>
</div>
