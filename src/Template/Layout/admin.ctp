...
<body>
        ...
        <div class="container">
            <div class="menu-left pull-left">
                <ul>
                    ...
                    <li class="menu-parent <?php echo (strpos($controller, "product") !== false)?"actived":"" ?>">
                        <a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'Products', 'action' => 'index']) ?>">
                            <i class="fa fa-cube"></i> <?= __('Sản phẩm') ?>
                        </a>
                        <ul>
                            <li>
                                <a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'Products', 'action' => 'index']) ?>">
                                    <i class="fa fa-list-alt"></i> <?= __('Tất cả sản phẩm') ?>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'ProductCategories', 'action' => 'index']) ?>">
                                    <i class="fa fa-th"></i> <?= __('Danh mục') ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-parent <?php echo (strpos($controller, "order") !== false)?"actived":"" ?>">
                        <a href="#">
                        ...
                        <ul>
                            <li>
                                <a href="#">
                                    <i class="fa fa-file"></i> <?php echo __('Hóa đơn') ?>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-parent <?php echo (strpos($controller, "customer") !== false)?"actived":"" ?>">
                        <a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'Customers', 'action' => 'index']) ?>">
                            <i class="fa fa-male"></i> <?php echo __('Khách hàng') ?>
                        </a>
                        <ul>
                            <li>
                                <a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'Customers', 'action' => 'add']) ?>">
    ...
    <div class="footer">
        <div class="container">
            <span>&COPY; 2017. CMS được phát triển bởi <a href="http://ppo.vn/">PPO.VN</a></span>
        </div>
    </div>
    <!--END: FOOTER-->
